...
SAMPLE_LINE=$(sed "${SLURM_ARRAY_TASK_ID}q;d" samples_to_run.txt)
...
bcftools mpileup -Ov -r PvP01_10_v2:478539-483333 -f PlasmoDB-67_PvivaxP01_Genome.fasta $SAMPLE_BAM | python3 mpileup_to_fasta.py $CONSENSUS_FASTA $SAMPLE_NAME
